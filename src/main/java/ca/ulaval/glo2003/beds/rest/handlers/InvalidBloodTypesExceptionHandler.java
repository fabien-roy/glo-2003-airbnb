...
public class InvalidBloodTypesExceptionHandler implements ExceptionHandler<InvalidBloodTypesException> {
  ...
  private String badRequest() throws JsonProcessingException {
    ErrorResponse response =
        new ErrorResponse(
            "INVALID_BLOOD_TYPES", "blood types should be one or many of\n" +
