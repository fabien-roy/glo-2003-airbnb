...
public class InvalidCleaningFrequencyExceptionHandler implements ExceptionHandler<InvalidCleaningFrequencyException> {
  ...
  private String badRequest() throws JsonProcessingException {
    ErrorResponse response =
        new ErrorResponse(
            "INVALID_CLEANING_FREQUENCY", "cleaning frequency should be one of weekly, monthly, annual or never");
